...
# 加载营养数据
def load_nutrition_data(file_path='./file/final_merged_nutritional_data.xlsx'):
...
if __name__ == '__main__':
    file_path = './file_分析/(18, 30)_男_低_results_1000.csv'
    ...
    for age_range in age_ranges:
        ...
        file_name = './file_分析/' + str(age_range) + '_男_低_results_1000_abc.csv'
