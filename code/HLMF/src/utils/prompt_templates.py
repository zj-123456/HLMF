...
class PromptLibrary:
        ...
        self.templates = {
            "code": {
                "default": PromptTemplate(
                    "Please provide a detailed, technical, and accurate answer to the following issue:\n${query}\n\n"
                    "In your answer, include:\n"
                    "1. Detailed technical explanation\n"
                    "2. Specific examples and source code (if applicable)\n"
                    "3. Alternative approaches\n"
                    "4. Considerations about performance and security\n"
            ...
            "llm": {
                "default": PromptTemplate(
                    "Please provide a concise, clear, and efficient answer to:\n${query}\n\n"
                    "The answer should:\n"
    ...
    def get_system_prompt(self, role: str) -> str:
        ...
        if role == "code":
            return "You are a professional programming assistant. Your task is to write high-quality source code."
        elif role == "gemma3_27b":
            return "You are an AI specializing in critical thinking and deep analysis."
        elif role == "llm":
            return "You are a concise AI language assistant, focused on providing quick and efficient answers."
