...
class DifferentialEvolution:
    def __init__(self, obj_func, bounds, pop_size=50, mutation_factor=0.8, crossover_probability=0.7,
    ...
    def optimize(self, verbose=False):
        ...
        # Print the results
        if verbose:
            print('Best solution:', np.round(best, 1), ' and the value is ', best_fitness)
            print('Time taken to run the algorithm is ', timer, ' ms.')

        # Return the best solution found
        return np.round(best, 1), best_fitness, timer
...
if __name__ == '__main__':
    ...
    age_ranges =[(18, 30)] #[(18, 30)]  # [(7, 8)]# [(6, 7)]
    gender = ['男']  # ['男', '女']
    pal = ['低']  # ['低'] 中、高
    for age_range in age_ranges:
        ...
        file_name = 'D:\code\MOBO\zj\\analysis_recipes\\no_add_newingredient\\18_30_男_低/' + str(age_range) + '_男_低_results_gpt4o_de.csv'
